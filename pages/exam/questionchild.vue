		...
		<view class="page-tabs">
			...
			<!--#endif-->
				<view class="list-box bg" v-if="question">
					<view>
						<view class="list-li">
							<span v-html="question.qrquestion"></span>
						</view>
					</view>
				</view>
				<view class="list-box bg top" v-if="question" v-for="(question,index) in question.data" :key="index">
					<view>
						<view class="list-li">
...
<script setup>
	...
	const getData = async () => {
		const data = await ajax({
			route:'exam-phone-questions-child',
